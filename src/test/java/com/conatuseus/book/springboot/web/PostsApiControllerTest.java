...
public class PostsApiControllerTest {
    ...
    @Test
    @WithMockUser(roles = "USER")
    public void Posts_검색한다() throws Exception {
        // given
        String title = "title";
        String content = "content";
        ...
        PostsResponseDto responseDto = new ObjectMapper().readValue(mvcResult.getResponse().getContentAsString(), PostsResponseDto.class);
